...
# TechSci Labs Email Testing Platform - Complete Setup Script (macOS/zsh Compatible)
# Run this script to create the entire monorepo structure

echo "🚀 Creating TechSci Labs Email Testing Platform Structure..."

# Create main project directory (assuming you're already in it)
# mkdir techsci-labs
# cd techsci-labs
...
# Pages - Create individual files to avoid zsh glob issues
touch pages/index.vue
touch pages/login.vue
touch pages/register.vue
touch pages/pricing.vue

touch pages/dashboard/index.vue

# Dashboard accounts pages
touch pages/dashboard/accounts/index.vue
touch "pages/dashboard/accounts/[id].vue"
touch pages/dashboard/accounts/new.vue

# Dashboard domains pages
touch pages/dashboard/domains/index.vue
touch "pages/dashboard/domains/[id].vue"
touch pages/dashboard/domains/new.vue

# Dashboard emails pages
touch pages/dashboard/emails/index.vue
touch "pages/dashboard/emails/[id].vue"

# Dashboard API keys pages
touch pages/dashboard/api-keys/index.vue
touch pages/dashboard/api-keys/new.vue

# Dashboard settings pages
touch pages/dashboard/settings/index.vue
touch pages/dashboard/settings/profile.vue
touch pages/dashboard/settings/billing.vue
touch pages/dashboard/settings/team.vue

# Docs pages
touch pages/docs/index.vue
touch pages/docs/api.vue
touch pages/docs/guides.vue
touch pages/docs/examples.vue
...
# Create the problematic proxy file separately
mkdir -p server/api/proxy
...
touch config/packages/api_platform.yaml
touch config/packages/doctrine_mongodb.yaml
touch config/packages/mercure.yaml
touch config/packages/security.yaml
touch config/packages/validator.yaml
...
# Config
touch config/smtp.ini
touch config/plugins
touch config/host_list
touch config/me
...
echo ""
echo "Next steps:"
echo "1. cd techsci-labs (if not already there)"
